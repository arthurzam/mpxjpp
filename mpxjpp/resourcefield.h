...
#define RESOURCE_FIELD_GEN(F) \
	...
	F(INITIALS, DataType::STRING),\
	F(GROUP, DataType::STRING),\
	F(MAX_UNITS, DataType::UNITS),\
	F(BASE_CALENDAR, DataType::STRING),\
	F(STANDARD_RATE, DataType::RATE),\
	F(OVERTIME_RATE, DataType::RATE),\
	F(TEXT1, DataType::STRING),\
	F(TEXT2, DataType::STRING),\
	F(CODE, DataType::STRING),\
	...
	F(COST_PER_USE, DataType::CURRENCY),\
	F(ACCRUE_AT, DataType::ACCRUE),\
	...
	F(EMAIL_ADDRESS, DataType::STRING),\
	...
	F(BCWS, DataType::NUMERIC),\
	F(BCWP, DataType::NUMERIC),\
	F(ACWP, DataType::NUMERIC),\
	F(SV, DataType::NUMERIC),\
	F(AVAILABLE_FROM, DataType::DATE),\
	F(AVAILABLE_TO, DataType::DATE),\
	...
	\
	F(LEVELING_DELAY, DataType::STRING),\
	...
	F(WORKGROUP, DataType::WORKGROUP),\
	...
	F(MATERIAL_LABEL, DataType::STRING),\
	F(TYPE, DataType::RESOURCE_TYPE),\
	F(VAC, DataType::CURRENCY),\
	F(GROUP_BY_SUMMARY, DataType::STRING),\
	F(WINDOWS_USER_ACCOUNT, DataType::STRING),\
	...
	F(ENTERPRISE, DataType::BOOLEAN),\
	F(IMPORT, DataType::BOOLEAN),\
	F(CREATED, DataType::DATE),\
	F(BUDGET, DataType::BOOLEAN),\
	...
	\
	F(BOOKING_TYPE, DataType::BOOKING_TYPE),\
	F(BUDGET_COST, DataType::CURRENCY),\
	F(BUDGET_WORK, DataType::WORK),\
	F(CALENDAR_GUID, DataType::GUID),\
	F(COST_CENTER, DataType::STRING),\
	F(DEFAULT_ASSIGNMENT_OWNER, DataType::STRING),\
	F(ENTERPRISE_BASE_CALENDAR, DataType::STRING),\
	F(ENTERPRISE_REQUIRED_VALUES, DataType::STRING),\
	F(ENTERPRISE_TEAM_MEMBER, DataType::STRING),\
	F(ENTERPRISE_UNIQUE_ID, DataType::INTEGER),\
	F(ERROR_MESSAGE, DataType::STRING),\
	F(GENERIC, DataType::BOOLEAN),\
	F(INACTIVE, DataType::BOOLEAN),\
	F(REQUEST_DEMAND, DataType::STRING),\
	F(SUMMARY, DataType::STRING),\
	F(TEAM_ASSIGNMENT_POOL, DataType::BOOLEAN),\
	F(WBS, DataType::STRING),\
	F(UNAVAILABLE, DataType::STRING),\
	F(SUBPROJECT_RESOURCE_UNIQUE_ID, DataType::INTEGER),\
	...
	F(COST_RATE_A, DataType::BINARY),\
	F(COST_RATE_B, DataType::BINARY),\
	F(COST_RATE_C, DataType::BINARY),\
	F(COST_RATE_D, DataType::BINARY),\
	F(COST_RATE_E, DataType::BINARY),\
	F(AVAILABILITY_DATA, DataType::BINARY),\
	F(ENTERPRISE_DATA, DataType::BINARY),\
	F(OVERTIME_RATE_UNITS, DataType::RATE_UNITS),\
	F(STANDARD_RATE_UNITS, DataType::RATE_UNITS),\
	\
	...
	F(ENTERPRISE_RBS, DataType::STRING),\
	F(ENTERPRISE_NAME_USED, DataType::STRING),\
	F(ENTERPRISE_IS_CHECKED_OUT, DataType::BOOLEAN),\
	F(ENTERPRISE_CHECKED_OUT_BY, DataType::STRING),\
	F(ENTERPRISE_LAST_MODIFIED_DATE, DataType::DATE),\
	F(ENTERPRISE_MULTI_VALUE20, DataType::STRING),\
	F(ENTERPRISE_MULTI_VALUE21, DataType::STRING),\
	F(ENTERPRISE_MULTI_VALUE22, DataType::STRING),\
	F(ENTERPRISE_MULTI_VALUE23, DataType::STRING),\
	F(ENTERPRISE_MULTI_VALUE24, DataType::STRING),\
	F(ENTERPRISE_MULTI_VALUE25, DataType::STRING),\
	F(ENTERPRISE_MULTI_VALUE26, DataType::STRING),\
	F(ENTERPRISE_MULTI_VALUE27, DataType::STRING),\
	F(ENTERPRISE_MULTI_VALUE28, DataType::STRING),\
	F(ENTERPRISE_MULTI_VALUE29, DataType::STRING),\
	F(ACTUAL_WORK_PROTECTED, DataType::WORK),\
	F(ACTUAL_OVERTIME_WORK_PROTECTED, DataType::WORK),\
	F(PARENT_ID, DataType::INTEGER),\
